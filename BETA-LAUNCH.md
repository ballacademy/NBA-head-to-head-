...
- [x] Explicit copy: no password reset, local collection, All-Time coming soon
...
7. **Account** — create account on device A; log in on device B; GM code restores; collection note matches Beta notes.
